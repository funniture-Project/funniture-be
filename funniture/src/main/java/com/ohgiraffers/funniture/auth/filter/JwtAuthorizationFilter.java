    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        * */
        ...
        List<String> roleLeessList = Arrays.asList(
                ...
                "/api/v1/member(/\\w+)?",
                "/api/v1/member/.*",
                "/api/v1/member/rejected/.*",
                "/api/v1/member/check-store-no",
                "/api/v1/product/\\d+",
                "/api/v1/product/\\w+",
                "/api/v1/product",
                ...
                "/api/v1/rental/cancel",
                "/api/v1/rental/\\w+/delivery",
                "/api/v1/rental/\\d+/delivery",
                "/api/v1/rental/.*",
                "/api/v1/chat/.*",
                "/api/v1/deliveryaddress",
                ...
                "/api/v1/deliveryaddress/\\w+/regist",
                "/api/v1/deliveryaddress/\\d+/update",
                "/api/v1/deliveryaddress/\\w+/setDefault",
                "/api/v1/deliveryaddress/\\d+/setDefault",
                "/api/v1/deliveryaddress/\\w+/delete",
                "/api/v1/deliveryaddress/\\d+/delete",
                "/api/v1/point/\\w+",
                "/api/v1/point/\\d+",
                "/api/v1/point/logs/\\d+",
                "/api/v1/point/logs/\\w+",
