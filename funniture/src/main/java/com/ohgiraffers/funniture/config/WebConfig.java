...
import com.ohgiraffers.funniture.auth.filter.HeaderFilter;
import com.ohgiraffers.funniture.auth.interceptor.JwtTokenInterceptor;
        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/api/**")
                        .allowedOrigins("http://localhost:3000", "https://funnyfun.netlify.app")
